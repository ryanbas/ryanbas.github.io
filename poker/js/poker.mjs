...
export default class PokerApp {
    constructor() {
        this.storage = new StorageWrapper("ryanbas.dev/poker", 1);
    }

    withStorageWrapper(storageWrapper) {
    ...
    migrateStorage() {
        ...
        this.storage.migrateToCurrentVersion(storageVersionHistory, migrations);
    }
    ...
    run() {
        ...
        function loadFromStorage() {
            playerNames = thisapp.storage.loadArray("playerNames");
            if (playerNames == null) {
                playerNames = [];
            }
        ...
        function saveToStorage() {
            thisapp.storage.saveArray("playerNames", playerNames);
        }


        function main() {
            thisapp.migrateStorage();
            loadFromStorage();
